...
/**
 * DZap Core Swap Contract ABI (Staging)
 *
 * Staging/beta version of the core swap contract.
 * This version may contain experimental features and breaking changes.
 *
 * ⚠️ WARNING: Use only for testing and development purposes.
 *
 * @version staging
 * @status beta
 */
export const dZapCoreSwapAbi: Abi = [
  {
    type: 'error',
