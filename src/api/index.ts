...
import { BroadcastZapTxResponse, ZapBroadcastTxParams } from '../types/zap/broadcast';
...
export const broadcastZapTx = (request: ZapBroadcastTxParams): Promise<BroadcastZapTxResponse> =>
  invokeZap({
